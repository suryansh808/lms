    ...
    <div>
       <section className="py-10 px-4 bg-white">
        <div className="container mx-auto">
          <div  data-aos="fade-up" className="max-w-4xl mx-auto flex flex-col md:flex-row items-center border border-[#f15b29] bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="md:w-1/3 flex items-center justify-center p-6">
              <div className="text-center">
                <div
                 
                  className=" rounded-full flex items-center justify-center shadow-md mx-auto"
                >
                  <img src={logo} alt="" />
                </div>
              </div>
