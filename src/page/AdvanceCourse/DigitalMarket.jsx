  ...
  return (
    <div >
      <div className="bg-black text-white">
        {/* 1 hero part */}
        <section id="advancedigitalbg" className="py-[60px] shadow-lg shadow-[#f15b29] px-[10px] min-h-screen flex items-center justify-center">
          <div className="container mx-auto">
            <div className="">
              <h1 id="digital"  data-aos="fade-up" className="text-4xl text-center  font-bold mb-3">
    ...
    <i class="relative text-white "> Digital Marketing</i>
        ...
        <section className="py-[60px] px-[10px]">
          <div className="container mx-auto lg:flex flex-col lg:flex-row">
            <div className="w-full mb-3 lg:mb-0">
              ...
              <ul className="space-y-4">
                ...
                <li>
                      ...
                      Learn to design impactful content and multi-platform
                    ...
                    Gain skills to increase brand awareness and enhance
                    performance through strategic online marketing techniques.
                    <li>
                      <span className="font-semibold text-[#f15b29]">
            ...
            <div  data-aos="fade-up" className="lg:w-1/2 w-full h-[300px] rounded-lg shadow-lg shadow-[#926E4E] overflow-hidden" >
              <img
                src={DM}
                alt="Curriculum"
        ...
        <section className="py-[60px] px-[10px]">
          ...
          >
           ...
           <button className="bg-[#f15b29] hover:bg-[#f15b29] text-white font-semibold py-2 px-6 rounded flex items-center gap-2 mt-4 md:mt-0">
             ...
             <a href='/src/assets/Advanced Course Images/Digital Markting/Digital Marketing Advanced Program.pdf' target="blank"> Download</a>
            </button>
            <button
