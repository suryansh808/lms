...
export const DmarketingSkill = () => {
  return <footer><p>Footer Component</p></footer>;
};


export const IbankingSkill = () => {
  return <aside><p>Sidebar Component</p></aside>;
};


export const MstackSkill = () => {
  return <main><p>Main Content</p></main>;
};

export const PmarketingSkill = () => {
    return <main><p>Main Content</p></main>;
  };


export const PmanagementSkill = () => {
