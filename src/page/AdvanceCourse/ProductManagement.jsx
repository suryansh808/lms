  ...
  return (
    <div>
      <div className="bg-black text-white">
        {/*1  hero part */}
        <section id="advanceproductbg" className="py-[60px] px-[10px] shadow-lg shadow-[#f15b29] min-h-screen flex items-center justify-center">
    ...
    <i class="relative text-white ">Product Management</i>
        ...
        <section className="py-[60px] px-[10px]">
          ...
          <h2
            ...
            >
              | Why Choose <span className="text-white">Product Management ? </span>
            </h2>
        ...
        <div
          ...
          >
           ...
           <button className="bg-[#f15b29] hover:bg-[#f15b29] text-white font-semibold py-2 px-6 rounded flex items-center gap-2 mt-4 md:mt-0">
              ...
              <a href='/src/assets/Advanced Course Images/Product management/Product management Advanced program.pdf' target="blank"> Download</a>
            </button> 
            <button
