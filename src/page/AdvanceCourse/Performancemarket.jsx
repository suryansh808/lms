  ...
  return (
    <div>
      <div className="bg-black text-white">
        {/* 1 hero part */}
        <section id="advanceperformancebg" className=" py-[60px] px-[10px] shadow-lg shadow-[#f15b29] min-h-screen flex items-center justify-center">
          <div className="container mx-auto">
            <div className="">
              <h1 data-aos='fade-up' className="text-4xl text-center font-bold mb-4">
    ...
    <i class="relative text-white ">  Performance Marketing</i>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                <div data-aos='fade-up' data-aos-duration='500' className="flex flex-col backdrop-blur-md bg-[#ffffff59] text-black items-center p-6 border border-gray-700 rounded-md">
                ...
                <div data-aos='fade-up' data-aos-duration='1000' className="flex flex-col backdrop-blur-md bg-[#ffffff59] text-black items-center p-6 border  border-gray-700 rounded-md">
                  <div className="bg-[#f15b29] p-3 rounded-full">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="white"
                ...
                <div data-aos='fade-up' data-aos-duration='1500' className="flex flex-col backdrop-blur-md bg-[#ffffff59] text-black items-center p-6 border border-gray-700 rounded-md">
                  <div className="bg-[#f15b29] p-3 rounded-full">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="white"
                  ...
                  <p><span className="text-[#f15b29]">★★★★</span>☆ (4.9/5)</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-[60px] px-[10px]">
          <div className="container mx-auto lg:flex flex-col lg:flex-row gap-3">
            ...
            <div className="w-full mb-3 lg:mb-0">
              <h2  data-aos="fade-up" className="text-2xl font-bold mb-4 text-[#f15b29]">
                | Key Takeaways
              </h2>
            ...
            <div data-aos="fade-up" className="lg:w-1/2 w-full h-[300px] rounded-lg shadow-lg shadow-[#f15b29] overflow-hidden" >
              <img
                src={PM}
                alt="Curriculum"
        ...
        <section className="py-[60px] px-[10px]">
          ...
          >
           ...
           <button className="bg-[#f15b29] hover:bg-[#f15b29] text-white font-semibold py-2 px-6 rounded flex items-center gap-2 mt-4 md:mt-0">
              ...
              <a href='/src/assets/Advanced Course Images/Performance marketing/Performance marketing Advanced Program.pdf' target="_blank">Download</a>
            </button>
            <button
          ...
          <div className="container mx-auto">
            <div className="">
              <div className=" w-full mb-8 lg:mb-0">
                ...
                <div data-aos="fade-up" className="grid grid-cols-1 md:grid-cols-2 gap-2">
