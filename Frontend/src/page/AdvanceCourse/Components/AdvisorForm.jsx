  ...
  return (
    <div>
      ...
      <button
        ...
        className="bg-[#EEEEEE] border text-black font-semibold  ease-linear duration-500 px-6 py-2 hover:rounded-2xl hover:text-black rounded-sm">
        Apply Now
      </button>
      {showForm && (
            <div className="fixed inset-0 lg:top-10 top-[20%] bg-gray-700 bg-opacity-50 z-[999] lg:flex justify-center items-center px-[20px]">
               ...
               <div id="hidden"  className="lg:w-1/2 md:w-1/2 relative text-black rounded-lg">
               <h2 className="text-center font-bold text-[#f15b29] my-2">Krutanic Solutions</h2>
               <ul className=" text-lg space-y-2 px-2">
                <li><i class="fa fa-hand-o-right text-[#f15b29] pr-2"></i>Hands-On Learing Via 50+ Projects</li>
                <li><i class="fa fa-hand-o-right text-[#f15b29] pr-2"></i>1:1 Mentorship From AI Specialists</li>
                <li><i class="fa fa-hand-o-right text-[#f15b29] pr-2"></i>Personalized  Career Guidence </li>
              </ul>
                    <div className="flex items-center justify-center">
                    <img src={girl} alt="girl" className="absolute  bottom-0 h-[280px]" />
                    </div>
                </div>
